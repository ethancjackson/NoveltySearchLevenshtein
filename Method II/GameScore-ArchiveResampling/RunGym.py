...
for index, game_name in enumerate(game_names):
    ...
    gs_ind_file = open('{}/GameScore-ValidationBest.txt'.format(game_dir), 'r')
    rs_ind_file = open('{}/ArchiveResample-ValidationBest.txt'.format(game_dir), 'r')
    ...
    for ep in episodes:
        ...
        print('{} - ArchiveResample'.format(game_name))
...
#         print(score)
#         gs_scores.append(score)
#         print('{} - Archive Resampling'.format(game_name))
