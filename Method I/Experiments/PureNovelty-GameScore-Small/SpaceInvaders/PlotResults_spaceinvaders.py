...
plt.savefig('./MethodI-SpaceInvaders-Means.pdf', dpi=1000)
plt.figure()
...
plt.savefig('./MethodI-SpaceInvaders-Highs.pdf', dpi=1000)
plt.figure()
...
plt.savefig('./MethodI-SpaceInvaders-Validation.pdf', dpi=1000)
# plt.show()